...
public class RegisterActivity extends BaseActivity{
    ...
    private TextView et_register_phonenumber;//原为editText 后改为手机验证后传入手机号 故改为TextView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_register_phonenumber = (TextView)findViewById(R.id.et_registerphonenumber);
        ...
        et_register_phonenumber.setText(phone);
